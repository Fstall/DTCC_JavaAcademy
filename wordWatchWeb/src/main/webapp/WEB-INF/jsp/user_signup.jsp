...
<head>
	<title>mass.term.mind - User Sign Up</title>
...
<div class="rs_main_header">
    ...
    <div class="rs_container">
        ...
        <form action="">
        <table style="font-family:MS Reference Sans Serif, Arial, Helvetica, sans-serif">
        <tr><td style="color:#FFFFFF">
        Email*
        </td>
        <td><input placeholder="your email is your username" type="text" name="Username" /></td>
...
%>
        ...
        <tr><td style="font-size:10px;color:#FFFFFF">*Your email will be your username</td></tr>
        <tr><td style="color:#FFFFFF">Create Password*
        </td>
        <td><input id="password1" type="password" placeholder="password" name="NewPassword"/></td></tr>
        <tr><td style="color:#FFFFFF">Retype Password*</td>
        <td><input id="password2" type="password" placeholder="password" name="RetypePassword" /></td>
        <td><p id="validate-status" style="color:#FFFFFF; font-size:12px"></p></td>
        </tr>
        <tr><td style="color:#FFFFFF">Country of Origin</td>
...
<tr><td style="font-size:8px; color:#F5F5F5">For reference and statistics only.</td></tr>
<tr><td style="font-size:10px; color:#F5F5F5"">*Required</td></tr>
<tr><td><input type="submit" name="event" value="Sign Up!" /></td></tr>
        </table>
        </form>
</body>
</html>
