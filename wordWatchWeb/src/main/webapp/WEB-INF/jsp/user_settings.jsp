...
<head>
	<title>mass.term.mind - user settings</title>
...
<body class="rs_main_background"; onload="runAccordion(1)">
<div class="rs_main_header">
        ...
        <tr>
            <td>
                ...
                <td align="right" valign="top">
                    <span id="company_signout" style="text-align: center; margin-left: 10px;">
                    <a style="text-decoration: none; color:#FFFFFF" href="tbd">Sign Out</a></span>
                </td>
            </tr>
        </table>
    </div>
    <div style="height:310px;">
        <div id="AccordionContainer" class="AccordionContainer">
            <div>
                <div id="accordion1" class="AccordionTitle" onselectstart="return false;">Account Settings</div>
            </div>
            <div id="Accordion1Content" class="AccordionContent">
                <form name="passwordchange" method="post" action="">
                Change Password<br />
                <table>
                    <tr>
                                <td>Old Password</td>
                                <td><input placeholder="old password" name="old password" type="password"
                                id="old password" maxlength="20" /><br /></td>
                            </tr>
                                <tr><td>New Password</td>
                                <td><input placeholder="new password" name="new password" type="password"
                                id="new password" maxlength="20" /></td></tr>
                                <tr><td>Retype New Password</td>
                                <td><input placeholder="retype new password" name="retype new password" type="password"
                                id="retype new password" maxlength="20" /></td></tr>
                                <tr><td><input type="submit" name="event" value="save" /></td></tr>
                                </table></form>
                                ...
                                <table><tr>
                                <td>Old Email</td>
                                <td><input placeholder="old email" name="old email" type="email" id="old email" /></td></tr>
                                <tr><td>New Email</td>
                                <td><input placeholder="new email" name="new email" type="email" id="new email" /></td></tr>
                                <tr><td>Password</td>
                                <td><input placeholder="type password" name="typepassword" type="password"
                                id="typepassword" maxlength="20" /></td></tr>
                                <tr><td><input type="submit" name="event" value="save" /></td></tr>
                </table></form>
            </div>
            <div>
                <div id="accordion2" class="AccordionTitle" onselectstart="return false;">Personal Settings</div>
            </div>
            <div id="Accordion2Content" class="AccordionContent">
            <form action="">
            <table>
                        <tr><td>First Name</td>
                        <td><input name="name" type="text" id="firstname" /></td></tr>
                        <tr><td>Last Name</td>
                        <td><input name="name" type="text" id="lastname" /></td></tr>
...
<tr><td><input type="submit" name="event" value="save" /></td></tr>
            ...
            <div>
                <div id="accordion3" class="AccordionTitle" onselectstart="return false;">Privacy Settings</div>
            </div>
            <div id="Accordion3Content" class="AccordionContent">
            Allow other users to request viewing priveleges<br />
            <form action="">
            ...
            <div>
                <div id="accordion4" class="AccordionTitle" onselectstart="return false;">Share Settings</div>
            </div>
            ...
            <input type="search" />
            <input type="submit" value="Add"/><br />
            !!Blacklist here with removal function. Can be combined with blacklist function above.!!

            </div>
            <div>
                <div id="accordion5" class="AccordionTitle" onselectstart="return false;">Accordion 5</div>
            </div>
